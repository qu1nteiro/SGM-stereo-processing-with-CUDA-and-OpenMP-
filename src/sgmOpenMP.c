...
// sgmOpenMP — final version with all four steps parallelised.
// Only sgmOpenMP() was modified — sgmHost() and all helper functions above are
// the professor's reference implementation and are left untouched.
